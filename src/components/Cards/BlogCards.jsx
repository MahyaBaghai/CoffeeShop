...
export default function BlogCards({ dark, img, title, day, month, year }) {
  return (
    <>
      <div
        className={`${
      ...
      >
        ...
        <div className="relative group">
          <div className="rounded-2xl rounded-br-5xl shrink-0 max-sm:w-[180px] max-sm:h-[180px] max-xs:w-[160px] max-xs:h-[160px] max-2xs:w-[140px] max-2xs:h-[140px]  overflow-hidden">
            <img src={img} alt={title} className="rounded-2xl rounded-br-5xl h-full object-cover" />
          </div>
          {/* overlay section */}
        ...
        {/* Texts section */}
        <div className="flex max-sm:flex-col sm:items-center mt-4 mb-2 max-sm:mx-5 max-xs:mx-3 max-2xs:mx-1 font-PoppinsMedium ">
          {/* Title section */}
          <div
          ...
          <div
            ...
            } sm:h-15 max-sm:w-full lg:mx-4 sm:mx-3 max-sm:my-6 `}
          ></div>
          ...
          <div className="max-sm:flex max-sm:justify-between max-sm:gap-2 max-sm:items-center ">
            ...
            <div className="flex sm:hidden text-orange-300 items-center justify-end bg-orange-200/20 px-2  py-0.5 rounded-md">
              <div className="font-PoppinsMedium text-xs 2xs:text-sm font-medium">Read</div>
